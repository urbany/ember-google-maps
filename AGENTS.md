...
- Runtime API loading is centralized in the `google-maps-api` service; map primitives are _not_ Glimmer components in the usual sense—they are “map components” managed by a custom `MapComponentManager`.
